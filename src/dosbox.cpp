...
void DOSBOX_Init(void) {
	...
	Pint = secprop->Add_int("rate", only_at_start, 44100);
	...
	const char *latencies[] = {"5", "10", "20", "50", "100", 0};
	Pint = secprop->Add_int("latency", only_at_start, 20);
	Pint->Set_values(latencies);
	Pint->Set_help("Desired audio latency in milliseconds.");
